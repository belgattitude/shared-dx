...
- [#1247](https://github.com/belgattitude/shared-dx/pull/1247) [`a85b294`](https://github.com/belgattitude/shared-dx/commit/a85b29421fcd4793a2c83927f74a56593c6170c3) Thanks [@belgattitude](https://github.com/belgattitude)! - All plugins to latest
  ...
  ```
   ...
   @typescript-eslint/typescript-estree   ^8.63.0  →   ^8.65.0
   @typescript-eslint/utils               ^8.63.0  →   ^8.65.0
   @vitest/eslint-plugin                  ^1.6.21  →   ^1.6.24
   eslint-plugin-jest                    ^29.15.4  →  ^29.16.0
   eslint-plugin-perfectionist             ^5.9.1  →   ^5.10.0
...
- [#1237](https://github.com/belgattitude/shared-dx/pull/1237) [`80ca8d2`](https://github.com/belgattitude/shared-dx/commit/80ca8d20c785e6b85cea941ab265dd3c58d27a8f) Thanks [@belgattitude](https://github.com/belgattitude)! - All plugins to latest

  ```
   @tanstack/eslint-plugin-query         ^5.101.1  →  ^5.101.2
   @typescript-eslint/eslint-plugin       ^8.62.1  →   ^8.63.0
   @typescript-eslint/parser              ^8.62.1  →   ^8.63.0
   @typescript-eslint/typescript-estree   ^8.62.1  →   ^8.63.0
   @typescript-eslint/utils               ^8.62.1  →   ^8.63.0
   @vitest/eslint-plugin                  ^1.6.20  →   ^1.6.21
   eslint-plugin-jest                    ^29.15.3  →  ^29.15.4
...
- [#1209](https://github.com/belgattitude/shared-dx/pull/1209) [`9900b1b`](https://github.com/belgattitude/shared-dx/commit/9900b1bd931f7f1e7f99e10eedb112b25b3162fa) Thanks [@belgattitude](https://github.com/belgattitude)! - All plugins to latest

  ```
   @tanstack/eslint-plugin-query         ^5.100.6  →  ^5.101.0
   @typescript-eslint/eslint-plugin       ^8.59.1  →   ^8.62.0
   @typescript-eslint/parser              ^8.59.1  →   ^8.62.0
   @typescript-eslint/typescript-estree   ^8.59.1  →   ^8.62.0
   @typescript-eslint/utils               ^8.59.1  →   ^8.62.0
   ...
   eslint-plugin-storybook                 10.3.6  →    10.4.6
  ```
...
- [#1196](https://github.com/belgattitude/shared-dx/pull/1196) [`707325d`](https://github.com/belgattitude/shared-dx/commit/707325d32ae49b15cfece8ea2ff0a3eb67a5a3e0) Thanks [@belgattitude](https://github.com/belgattitude)! - All plugins to latest
...
- [#1189](https://github.com/belgattitude/shared-dx/pull/1189) [`48f36b5`](https://github.com/belgattitude/shared-dx/commit/48f36b55088f256f3e5d8a812151ea7bbe700ead) Thanks [@belgattitude](https://github.com/belgattitude)! - Plugins to latest

  ```
   @typescript-eslint/eslint-plugin      ^8.58.2  →  ^8.59.0
   @typescript-eslint/parser             ^8.58.2  →  ^8.59.0
   @typescript-eslint/typescript-estree  ^8.58.2  →  ^8.59.0
   @typescript-eslint/utils              ^8.58.2  →  ^8.59.0
...
- [`6c48572`](https://github.com/belgattitude/shared-dx/commit/6c4857208435a0552a814e0cfd326d75b0344afc) Thanks [@belgattitude](https://github.com/belgattitude)! - Typescript 6 support

  ```
   @typescript-eslint/eslint-plugin       ^8.57.2  →   ^8.58.0
   @typescript-eslint/parser              ^8.57.2  →   ^8.58.0
   @typescript-eslint/typescript-estree   ^8.57.2  →   ^8.58.0
...
- [#1157](https://github.com/belgattitude/shared-dx/pull/1157) [`67fa202`](https://github.com/belgattitude/shared-dx/commit/67fa202a285972a8845db89e2bfb03182481bf9c) Thanks [@belgattitude](https://github.com/belgattitude)! - All plugins to latest

  ```
   @rushstack/eslint-patch                ^1.15.0  →   ^1.16.1
   @tanstack/eslint-plugin-query          ^5.91.2  →   ^5.91.4
   @typescript-eslint/eslint-plugin       ^8.53.0  →   ^8.57.0
   @typescript-eslint/parser              ^8.53.0  →   ^8.57.0
   @typescript-eslint/typescript-estree   ^8.53.0  →   ^8.57.0
   @typescript-eslint/utils               ^8.53.0  →   ^8.57.0
   @vitest/eslint-plugin                   ^1.6.6  →   ^1.6.10
   eslint-plugin-jest                    ^29.12.1  →  ^29.15.0
   eslint-plugin-mdx                        3.6.2  →     3.7.0
   eslint-plugin-perfectionist             ^5.3.1  →    ^5.6.0
   eslint-plugin-playwright                ^2.5.0  →    ^2.9.0
...
- [#1148](https://github.com/belgattitude/shared-dx/pull/1148) [`86dd9b9`](https://github.com/belgattitude/shared-dx/commit/86dd9b9ed132f809333773db88a39409543740a0) Thanks [@belgattitude](https://github.com/belgattitude)! - Update plugins to latest

  ```
   @typescript-eslint/eslint-plugin      ^8.49.0  →   ^8.53.0
   @testing-library/react                 16.3.0  →    16.3.1
   @typescript-eslint/parser             ^8.49.0  →   ^8.53.0
   @typescript-eslint/typescript-estree  ^8.49.0  →   ^8.53.0
   @typescript-eslint/utils              ^8.49.0  →   ^8.53.0
   @vitest/eslint-plugin                  ^1.5.2  →    ^1.6.6
   eslint-plugin-jest                    ^29.2.1  →  ^29.12.1
   eslint-plugin-perfectionist           ^4.15.1  →    ^5.3.1
   eslint-plugin-playwright               ^2.4.0  →    ^2.5.0
   eslint-plugin-prettier                 ^5.5.4  →    ^5.5.5
   eslint-plugin-testing-library         ^7.13.5  →   ^7.15.4
  ```
...
- [`ea403f5`](https://github.com/belgattitude/shared-dx/commit/ea403f5305c5b6b3cc15cc264950c78929002670) Thanks [@belgattitude](https://github.com/belgattitude)! - Disable sonarjs/function-return-type for react/jsx components
...
- [#1122](https://github.com/belgattitude/shared-dx/pull/1122) [`4b44c3f`](https://github.com/belgattitude/shared-dx/commit/4b44c3fe729add000165e347512283992e28d2c9) Thanks [@belgattitude](https://github.com/belgattitude)! - All plugins to latest

  ```
   @typescript-eslint/eslint-plugin      ^8.47.0  →  ^8.48.0
   @typescript-eslint/parser             ^8.47.0  →  ^8.48.0
   @typescript-eslint/typescript-estree  ^8.47.0  →  ^8.48.0
   @typescript-eslint/utils              ^8.47.0  →  ^8.48.0
   eslint-plugin-jest                    ^29.1.0  →  ^29.2.1
   eslint-plugin-testing-library         ^7.13.4  →  ^7.13.5
  ```
...
- [#1108](https://github.com/belgattitude/shared-dx/pull/1108) [`09e6525`](https://github.com/belgattitude/shared-dx/commit/09e6525c3d447c2ca01fc184f6e2057eeb59a93b) Thanks [@belgattitude](https://github.com/belgattitude)! - ## next-env.d.ts exclusions
...
- [#1080](https://github.com/belgattitude/shared-dx/pull/1080) [`57c8ece`](https://github.com/belgattitude/shared-dx/commit/57c8ecee6c603bef338a71bdfb8980243fffd1b5) Thanks [@belgattitude](https://github.com/belgattitude)! - Re-release 8.1.0
...
- [#1080](https://github.com/belgattitude/shared-dx/pull/1080) [`57c8ece`](https://github.com/belgattitude/shared-dx/commit/57c8ecee6c603bef338a71bdfb8980243fffd1b5) Thanks [@belgattitude](https://github.com/belgattitude)! - Re-release 8.1.0 with provenance
  - [#1076](https://github.com/belgattitude/shared-dx/pull/1076) [`58f774b`](https://github.com/belgattitude/shared-dx/commit/58f774b45bef0c8e32f869db19a86dc4f6bfdb95) Thanks [@belgattitude](https://github.com/belgattitude)! - All deps to latest and upgrade eslint-plugin-react-hooks to v7 (from v6)
...
- [#1077](https://github.com/belgattitude/shared-dx/pull/1077) [`8c21abd`](https://github.com/belgattitude/shared-dx/commit/8c21abddc2b46edf33802f7bedd3245ac221b8ca) Thanks [@belgattitude](https://github.com/belgattitude)! - Re-release 8.1.0
  - [#1076](https://github.com/belgattitude/shared-dx/pull/1076) [`58f774b`](https://github.com/belgattitude/shared-dx/commit/58f774b45bef0c8e32f869db19a86dc4f6bfdb95) Thanks [@belgattitude](https://github.com/belgattitude)! - All deps to latest and upgrade eslint-plugin-react-hooks to v7 (from v6)
